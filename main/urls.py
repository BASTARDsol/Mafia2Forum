...
urlpatterns = [
    ...
    path("operations/create/", views.operation_create, name="operation-create"),
    path("operations/<int:operation_id>/", views.operation_detail, name="operation-detail"),
    path("operations/<int:operation_id>/checklist/add/", views.operation_add_checklist_item, name="operation-checklist-add"),
    path("operations/checklist/<int:item_id>/toggle/", views.operation_toggle_checklist_item, name="operation-checklist-toggle"),
    path("recruitments/", views.recruitments_list, name="recruitments"),
    path("recruitments/create/", views.recruitment_create, name="recruitment-create"),
