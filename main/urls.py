...
urlpatterns = [
    ...
    path("family/hq/", views.family_hq, name="family-hq"),
    ...
    path("family/operations/create/", views.create_family_operation, name="create-family-operation"),
    path("family/dossiers/create/", views.create_faction_dossier, name="create-faction-dossier"),
    path("family/tasks/create/", views.create_family_task, name="create-family-task"),
    path("family/tasks/<int:task_id>/claim/", views.claim_family_task, name="claim-family-task"),
    path("family/tasks/<int:task_id>/complete/", views.complete_family_task, name="complete-family-task"),
    ...
    path("topic/<int:topic_id>/toggle-closed/", views.toggle_topic_closed, name="topic-toggle-closed"),
    path("topic/<int:topic_id>/auto-close/", views.set_topic_auto_close, name="topic-auto-close"),
